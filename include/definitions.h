...
#define TRANSLATE_OBJECT_UP 7
#define TRANSLATE_OBJECT_DOWN 8
#define TRANSLATE_OBJECT_RIGHT 9
#define TRANSLATE_OBJECT_LEFT 10
...
#define ROTATE_OBJECT_CLOCKWISE 15
#define ROTATE_OBJECT_ANTI_CLOCKWISE 16
