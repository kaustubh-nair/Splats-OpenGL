...
void Mesh::setup()
{
  ...
  for(faceNormal = faceNormals.begin(); faceNormal < faceNormals.end(); faceNormal++)
  {
    ...
    glm::vec3 v3 = glm::normalize(glm::vec3(rotationMat * glm::vec4(glm::normalize(v2-v1),1.0f)) + v1);

    rotationMat = glm::rotate(glm::mat4(1.0f), glm::radians(120.0f), *faceNormal);
    glm::vec3 v4 = glm::normalize(glm::vec3(rotationMat * glm::vec4(glm::normalize(v2-v1),1.0f)) + v1);

    rotationMat = glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), *faceNormal);
    glm::vec3 v5 = glm::normalize(glm::vec3(rotationMat * glm::vec4(glm::normalize(v2-v1),1.0f)) + v1);

    rotationMat = glm::rotate(glm::mat4(1.0f), glm::radians(240.0f), *faceNormal);
    glm::vec3 v6 = glm::normalize(glm::vec3(rotationMat * glm::vec4(glm::normalize(v2-v1),1.0f)) + v1);

    rotationMat = glm::rotate(glm::mat4(1.0f), glm::radians(300.0f), *faceNormal);
    glm::vec3 v7 = glm::normalize(glm::vec3(rotationMat * glm::vec4(glm::normalize(v2-v1),1.0f)) + v1);
